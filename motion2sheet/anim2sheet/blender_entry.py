...
def key_body(arm,frame,x,z,hips,spine,head,lt,ls,rt,rs,lua,lfa):
    ...
    vals={"Hips":hips,"Spine":spine,"Head":head,"LeftUpLeg":lt,"LeftLeg":ls,"RightUpLeg":rt,"RightLeg":rs,"LeftUpperArm":lua,"LeftForeArm":lfa}
    for name,deg in vals.items(): key_y(arm,name,deg,frame)
...
def animate(arm,sword,frames):
    ...
    # Left arm is authored as counterbalance instead of forcing an unstable second IK chain.
    body=[
        (1,0.00,0.00,0,0,0,-7,10,7,-10,18,-25),
        (3,0.00,-0.04,-6,-11,5,-12,20,12,-16,8,-12),
        (4,0.00,-0.09,-14,-20,8,-18,30,18,-24,-4,8),
        (6,0.08,-0.07,-5,-11,4,-29,38,14,-20,-16,18),
        (7,0.15,-0.05,7,4,-2,-34,42,10,-16,-28,26),
        (8,0.23,-0.03,16,17,-7,-38,44,8,-13,-42,30),
        (9,0.31,-0.02,25,29,-11,-39,44,6,-10,-55,24),
        (10,0.37,-0.01,31,36,-14,-37,41,5,-8,-62,18),
        (12,0.43,-0.03,34,40,-15,-31,34,8,-11,-48,8),
        (13,0.45,-0.05,28,34,-12,-25,29,10,-14,-36,-4),
        (16,0.40,-0.02,5,7,-2,-12,18,9,-13,12,-18),
    ]
    for row in body: key_body(arm,*row)
    by={r[0]:r for r in body}
    sword_keys=[(1,0.18,1.30,46),(3,0.30,1.31,58),(4,0.42,1.34,76),(6,0.42,1.31,82),(7,0.34,1.27,70),(8,0.20,1.23,28),(9,0.02,1.18,-34),(10,-0.10,1.13,-74),(12,-0.05,1.08,-100),(13,0.04,1.11,-80),(16,0.24,1.25,34)]
