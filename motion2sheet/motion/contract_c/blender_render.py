...
def main() -> None:
    ...
    retarget = {
        ...
        "translationFormula": "pHips = pRest + Ltarget*Troot + Qroot*(Ltarget*HipsOffset)",
        "rootApplication": "virtual Root folded into mapped Hips and all semantic world rotations",
