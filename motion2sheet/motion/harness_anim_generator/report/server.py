    ...
    *,
    ...
    write_json(
        report_dir / "history.json",
        {
            ...
            "memoryWorkingSet": state.get("memoryWorkingSet"),
            "memoryProposal": state.get("memoryProposal"),
            "memoryPersistence": state.get("memoryPersistence"),
            "events": events,
        },
        redactor,
    )
