...
def main() -> None:
    ...
    rig = validate_rig_document(capture_rig_document(input_path, armature))
    animation = validate_animation_document(capture_animation_document(input_path, armature, action, rig), rig)
