...
#
# The right fist follows the canonical forward axis (-Y). F2->F3 deliberately
# rotates Hips more than RightUpperArm so the body initiates the launch.
# F5 aligns RightUpperArm and RightLowerArm almost directly with -Y to create
# a readable straight-punch hero pose. The left arm stays a compact guard.
_POSES = [{'Hips': (0, 0, -8),
  'Spine': (1, 0, -6),
  'Chest': (2, 0, -8),
  'Neck': (0, 0, 2),
 ...
 {'Hips': (0, 0, -13),
  ...
  'LeftHand': (0, -125, -8),
  'RightShoulder': (0, 0, 2),
  'RightUpperArm': (0, -44, 16),
  'RightLowerArm': (0, 132, 18),
  'RightHand': (0, 122, 14),
  'LeftUpperLeg': (-13, -7, -3),
  'LeftLowerLeg': (8, 5, 0),
  'LeftFoot': (4, 3, -2),
 ...
 {'Hips': (-1, 0, -20),
  ...
  'LeftHand': (0, -125, -8),
  'RightShoulder': (0, 0, -2),
  'RightUpperArm': (0, -48, 12),
  'RightLowerArm': (0, 135, 16),
  'RightHand': (0, 125, 12),
  'LeftUpperLeg': (-14, -8, -4),
  'LeftLowerLeg': (9, 5, 0),
  'LeftFoot': (4, 3, -2),
 ...
 {'Hips': (2, 0, 12),
  ...
  'RightUpperArm': (0, -28, 50),
  'RightLowerArm': (0, 95, 45),
  'RightHand': (0, 85, 38),
  'LeftUpperLeg': (-11, -5, -1),
  'LeftLowerLeg': (7, 4, 0),
  'LeftFoot': (3, 2, -1),
 ...
 {'Hips': (1, 0, -2),
  ...
  'LeftHand': (0, -125, -9),
  'RightShoulder': (0, 0, 7),
  'RightUpperArm': (0, -38, 25),
  'RightLowerArm': (0, 120, 26),
  'RightHand': (0, 110, 22),
  'LeftUpperLeg': (-12, -6, -2),
  'LeftLowerLeg': (8, 5, 0),
  'LeftFoot': (4, 3, -2),
 ...
 {'Hips': (0, 0, -7),
  ...
  'LeftHand': (0, -125, -8),
  'RightShoulder': (0, 0, 5),
  'RightUpperArm': (0, -41, 19),
  'RightLowerArm': (0, 129, 20),
  'RightHand': (0, 119, 15),
  'LeftUpperLeg': (-12, -7, -3),
  'LeftLowerLeg': (8, 5, 0),
  'LeftFoot': (4, 3, -2),
