...
# Character-A visual tuning pass 3:
# - stronger rear-load -> forward weight transfer,
# - body-led launch with a larger pelvis/chest turn,
# - F4 is deliberately only half-extension so F5 owns the hit,
# - F6 carries the body through target instead of duplicating F5,
# - F7 recoil folds the arm back into guard instead of reading as a stop/wave.
...
_POSES = [{'Hips': (-3, 0, -14),
 ...
 {'Hips': (12, 0, 24),
  ...
  'LeftLowerArm': (0, -130, -22),
  'LeftHand': (-38, -120, -18),
  'RightShoulder': (0, 0, 22),
  'RightUpperArm': (0, -24, 50),
  'RightLowerArm': (0, 95, 42),
  'RightHand': (-35, 88, 38),
  'LeftUpperLeg': (-14, -5, -2),
  'LeftLowerLeg': (10, 5, 0),
  'LeftFoot': (5, 3, -1),
