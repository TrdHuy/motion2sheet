...
# Character-A visual tuning pass 5:
# keep the pass-4 body staging, exaggerate the staggered fighting stance and
# forward weight transfer, and flex the open Character-A hand out of the strike silhouette.
...
_POSES = [{'Hips': (-3, 0, -14),
 ...
 {'Hips': (-2, 0, -11),
  ...
  'LeftFoot': (6, 4, -3),
  'LeftToe': (0, 0, 0),
  'RightUpperLeg': (18, 11, 7),
  'RightLowerLeg': (-9, -7, 0),
  'RightFoot': (-6, -5, 10),
  'RightToe': (0, 0, 0)}]

_HIPS_TRANSLATIONS = [(-0.015, 0, -0.05),
 (-0.008, 0.05, -0.07),
 (0, 0.1, -0.11),
 (0.008, 0.05, -0.09),
 (0.015, -0.12, -0.08),
